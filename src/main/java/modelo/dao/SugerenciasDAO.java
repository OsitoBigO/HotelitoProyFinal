...
public class SugerenciasDAO {
    ...
    public SugerenciasDAO() throws SQLException {
       ...
       public List<msugerencia> getList(){
         
            PreparedStatement ps; //optimiza la ejecución sql
            ResultSet rs;
            
            String cadSQL = "SELECT m.idsugerencia, m.nombresuge, m.correosuge, m.infosuge, c.idtiposuge, c.nombretiposuge as NombreCategoria "
                    + " FROM sugerencia m inner join tiposugerencia c "
